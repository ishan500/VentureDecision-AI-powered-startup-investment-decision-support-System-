...
TARGET_COLUMN = "Funding_Readiness_Label"

MODEL_NAME = "funding_readiness.pkl"
...
# Predicted Class
df["Predicted_Funding_Readiness"] = best_model.predict(X)

# Prediction Confidence
probabilities = best_model.predict_proba(X)

df["Funding_Readiness_Confidence"] = (
...
df["Predicted_Funding_Readiness_Name"] = (
    df["Predicted_Funding_Readiness"].map(readiness_mapping)
)
...
print("Funding Readiness Predictions Saved Successfully")