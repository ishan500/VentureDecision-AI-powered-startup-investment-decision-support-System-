...
TARGET_COLUMN = "Unicorn_Label"

MODEL_NAME = "unicorn_probability.pkl"
...
print("Unicorn Probability Distribution")
...
# Predicted Unicorn Class

df["Predicted_Unicorn"] = best_model.predict(X)

# Unicorn Probability (%)

df["Unicorn_Probability"] = (
...
print()
print("Unicorn Probability Predictions Saved Successfully")