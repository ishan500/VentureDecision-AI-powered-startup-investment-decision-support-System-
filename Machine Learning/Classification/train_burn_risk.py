...
TARGET_COLUMN = "Burn_Risk_Label"

MODEL_NAME = "burn_risk.pkl"
...
print(f"Weighted Recall   : {best_recall:.3f}")
...
df["Burn_Risk_Prediction"] = best_model.predict(X)
df["Burn_Risk_Confidence"] = (
