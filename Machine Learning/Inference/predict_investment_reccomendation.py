...
# ==========================================================
# VentureDecision
# INVESTMENT RECOMMENDATION MODEL INFERENCE
...
MODEL_PATH = (
    r"C:\Users\Ishan  Singh\Desktop\VentureDecision"
    r"\Machine Learning\models\investment_recommendation.pkl"
)
...
print("\nTrained multi-class investment recommendation model loaded successfully.")
...
# Create dummy variables exactly as done during training
...
print("\nInvestment recommendation classes:")

print(model_classes)


# ==========================================================
# CONFIDENCE OF PREDICTED RECOMMENDATION
# ==========================================================
...
new_df["Investment_Recommendation_Prediction"] = (
...
new_df["Investment_Recommendation_Probability"] = (
...
for i, class_name in enumerate(model_classes):
    ...
    new_df[
        ...
        f"Investment_Recommendation_Class_{class_name}_Probability"
...
print(
    ...
    "INVESTMENT RECOMMENDATION MULTI-CLASS PREDICTIONS "
