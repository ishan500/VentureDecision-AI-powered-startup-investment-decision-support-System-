...
MODEL_PATH = (
    r"C:\Users\Ishan  Singh\Desktop\VentureDecision"
    r"\Machine Learning\models\risk_score.pkl"
)
...
# ==========================================================
# FEATURES USED DURING RISK MODEL TRAINING
# ==========================================================
...
print("\nTrained risk model loaded successfully.")
...
new_df["Risk_Prediction"] = predicted_class


new_df["Risk_Probability"] = (
