...
MODEL_PATH = (
    r"C:\Users\Ishan  Singh\Desktop\VentureDecision"
    r"\Machine Learning\models\unicorn_probability.pkl"
)
...
# ==========================================================
# LOAD TRAINED UNICORN MODEL
# ==========================================================

model = joblib.load(MODEL_PATH)

print("\nTrained unicorn prediction model loaded successfully.")
...
new_df["Unicorn_Prediction"] = predicted_class


new_df["Unicorn_Probability"] = (
...
print("UNICORN PREDICTIONS GENERATED SUCCESSFULLY")
