...
MODEL_PATH = (
    r"C:\Users\Ishan  Singh\Desktop\VentureDecision"
    r"\Machine Learning\models\ipo_probability.pkl"
)
...
print("\nTrained IPO probability model loaded successfully.")
...
# ==========================================================
# PREDICTED IPO PROBABILITY
# ==========================================================

predicted_probability = model.predict_proba(X_new)


# Probability of IPO = class 1
...
new_df["IPO_Prediction"] = predicted_class


new_df["IPO_Probability"] = ipo_probability
...
print("IPO PREDICTIONS GENERATED SUCCESSFULLY")
