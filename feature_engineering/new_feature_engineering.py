...
startup = pd.read_csv(
    r"C:\Users\Ishan  Singh\Desktop\VentureDecision\data\new_startup_information.csv",
    header=0
)

funding = pd.read_csv(
    r"C:\Users\Ishan  Singh\Desktop\VentureDecision\data\new_funding_financial.csv",
    header=1
)

growth = pd.read_csv(
    r"C:\Users\Ishan  Singh\Desktop\VentureDecision\data\new_growth_market.csv",
    header=0
)

news = pd.read_csv(
    r"C:\Users\Ishan  Singh\Desktop\VentureDecision\data\new_news_sentiment.csv",
    header=1
)

exit_history = pd.read_csv(
    r"C:\Users\Ishan  Singh\Desktop\VentureDecision\data\new_exit_history.csv",
    header=1
)
...
# ==========================================================
# SAVE NEW FEATURE ENGINEERED DATASET
# ==========================================================

merged_df.to_csv(
    r"C:\Users\Ishan  Singh\Desktop\VentureDecision\data\processed\new_feature_engineered_startups.csv",
    index=False
)

print("\n==========================================")
print("New Feature Engineered Dataset Saved Successfully!")
print("Location:")
print(
    r"C:\Users\Ishan  Singh\Desktop\VentureDecision\data\processed\new_feature_engineered_startups.csv"
)
